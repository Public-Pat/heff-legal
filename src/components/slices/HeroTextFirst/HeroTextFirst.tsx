...
import styles from "./HeroTextFirst.module.scss";
import VimeoBackground from "@/components/general/VimeoBackground/VimeoBackground";
import { HeroSliceHeroTextFirstPrimary } from "../../../../prismicio-types";
